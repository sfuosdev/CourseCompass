...
const Navbar = () => {
  return (
    <nav className="bg-primary-yellow flex items-center justify-between w-full h-[8rem] fixed top-0 z-10 space-x-[0.5rem] pr-[1rem]">
      <div className="absolute justify-start font-bold items-left mt-[-3rem] p-[1.5rem] text-[4vw]
                      md:relative md:inline md:mt-[3.125rem]
                      xl:text-5xl  
      ">
        <Link href="/">.Compass</Link>
      </div>
      <div className="flex flex-row w-[50vw] mt-[3.125rem] p-[1rem]
      ">
        <input
          type="text"
        ...
        />
        <svg className="relative hidden left-[-3rem] mt-[0.5rem]
                                lg:inline
        " xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
          <path d="M19.125 19.125L13.375 13.375M1.875 8.58333C1.875 9.46428 2.04852 10.3366 
          ...
          2.72277 5.20227 2.38564 6.01617C2.04852 6.83006 1.875 7.70238 1.875 8.58333Z" stroke="#ADADAD" 
