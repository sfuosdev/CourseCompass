      ...
      <div className="flex inline-flex mt-[3.125rem] m-2 pr-[2rem] space-x-2">
        <Link href="#" className="relative rounded-full">
          <img
            ...
            alt="Profile picture"
            className="rounded-full w-[7vw] md:w-[4vw] lg:w-[3vw] h-auto min-h-[3rem] min-w-[3rem] border border-black"
          />
        </Link>
        <button onClick={toggleMenu} ref={buttonRef} className={`transition-transform ${showMenu ? "rotate-180" : ""}`} >
          <svg xmlns="http://www.w3.org/2000/svg" width="23" height="13" viewBox="0 0 23 13" fill="none" className="opacity-50 hover:opacity-100">
