                ...
                {isLoginActive ? (
                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <select multiple name="majors" value={formData.majors} onChange={handleInputChange} className="block w-full p-2 mb-2">
                            ...
                            <select multiple name="minors" value={formData.minors} onChange={handleInputChange} className="block w-full p-2 mb-2">
                                <option value="none">None</option>
                                {departments.map((dept) => (
                                    <option key={dept.value} value={dept.value}>{dept.name}</option>
                                ))}
